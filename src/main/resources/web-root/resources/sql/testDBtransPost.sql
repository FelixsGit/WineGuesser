...
CREATE TABLE "public"."settings_history" ("gameSettingsId" BIGINT NOT NULL, "gameHost" VARCHAR(255)  NOT NULL, "gameId" VARCHAR(255)  NOT NULL, "qrCode" VARCHAR(8000)  NOT NULL, "url" VARCHAR(8000)  NOT NULL, "description" VARCHAR(8000)  NOT NULL, "servingOrder" VARCHAR(255) ) WITH OIDS;
