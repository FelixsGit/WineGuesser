/*
File name: C:\Users\Felix\IdeaProjects\Projects\wine_guesser\src\main\resources\web-root\resources\sql\testDBtransPost.sql
...
DROP TABLE IF EXISTS wine_guess."club" CASCADE;
CREATE TABLE wine_guess."club"("clubId" SERIAL NOT NULL,"clubName" VARCHAR(255) NOT NULL,"clubPassword" VARCHAR(255) NOT NULL,"numberOfTastings" INTEGER DEFAULT 0 NOT NULL,"numWinesCorrect" DOUBLE PRECISION DEFAULT 0.0000000000000000e+00 NOT NULL,"numWinesGuessed" DOUBLE PRECISION DEFAULT 0.0000000000000000e+00 NOT NULL,"averageWineCorrect" DOUBLE PRECISION DEFAULT 0.0000000000000000e+00 NOT NULL,"clubCreator" VARCHAR(255)) WITH OIDS;
ALTER SEQUENCE wine_guess."club_clubId_seq" RESTART WITH 4 INCREMENT BY 1;
DROP INDEX IF EXISTS "PRIMARY";
ALTER TABLE wine_guess."club" ADD CONSTRAINT "PRIMARY" PRIMARY KEY ("clubId");

/*
Dumping data for table 'public.club'
*/

INSERT INTO wine_guess."club"("clubId", "clubName", "clubPassword", "numberOfTastings", "numWinesCorrect", "numWinesGuessed", "averageWineCorrect", "clubCreator")VALUES (1, 'KlubbToppar', '53q8p0127', 1, 6.0000000000000000e+00, 8.0000000000000000e+00, 7.5000000000000000e-01, 'Felix');
INSERT INTO wine_guess."club"("clubId", "clubName", "clubPassword", "numberOfTastings", "numWinesCorrect", "numWinesGuessed", "averageWineCorrect", "clubCreator")VALUES (2, 'TestKlubben', '123', 13, 3.8000000000000000e+01, 1.0100000000000000e+02, 3.8000000000000000e-01, 'TestFelix1');
INSERT INTO wine_guess."club"("clubId", "clubName", "clubPassword", "numberOfTastings", "numWinesCorrect", "numWinesGuessed", "averageWineCorrect", "clubCreator")VALUES (3, 'RiojaKlubben', 'tvÃ¥ord', 1, 9.0000000000000000e+00, 4.4000000000000000e+01, 2.0000000000000001e-01, 'Felix');

/*
Table structure for table 'public.club_member'
*/

DROP TABLE IF EXISTS wine_guess."club_member" CASCADE;
CREATE TABLE wine_guess."club_member"("clubMemberId" SERIAL NOT NULL,"clubId" INTEGER NOT NULL,"username" VARCHAR(255) NOT NULL,"isBacchus" VARCHAR(255) NOT NULL) WITH OIDS;
ALTER SEQUENCE wine_guess."club_member_clubMemberId_seq" RESTART WITH 25 INCREMENT BY 1;
DROP INDEX IF EXISTS "PRIMARY00000";
ALTER TABLE wine_guess."club_member" ADD CONSTRAINT "PRIMARY00000" PRIMARY KEY ("clubMemberId");

/*
Dumping data for table 'public.club_member'
*/

INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (1, 1, 'Felix', 'true');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (2, 1, 'Linnea', 'false');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (3, 1, 'Vinberra', 'true');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (4, 1, 'Carina', 'true');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (5, 2, 'TestFelix1', 'false');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (6, 2, 'TestFelix2', 'true');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (7, 2, 'TestFelix3', 'false');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (8, 2, 'As', 'false');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (9, 2, 'cartop1', 'false');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (10, 2, 'cartop2', 'false');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (11, 2, 'Vinproffset', 'false');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (12, 2, 'LINTOP', 'false');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (13, 2, 'lintop2', 'false');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (14, 3, 'Felix', 'false');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (15, 3, 'Linnea', 'false');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (16, 3, 'LÃ¥dvinsViktor', 'false');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (17, 3, 'Tove', 'false');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (18, 3, 'Lillamy', 'false');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (19, 3, 'Carina', 'false');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (20, 3, 'Ingalill', 'false');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (21, 3, 'steffe rfe', 'false');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (22, 3, 'Vinberra', 'false');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (23, 3, 'dagny', 'true');
INSERT INTO wine_guess."club_member"("clubMemberId", "clubId", "username", "isBacchus")VALUES (24, 3, 'JUKKA', 'false');

/*
Table structure for table 'public.club_wine_stat'
*/

DROP TABLE IF EXISTS wine_guess."club_wine_stat" CASCADE;
CREATE TABLE wine_guess."club_wine_stat"("clubWineStatId" SERIAL NOT NULL,"clubId" INTEGER NOT NULL,"wineName" VARCHAR(255) NOT NULL,"wineUrl" VARCHAR(8000) NOT NULL,"numberOfServings" INTEGER NOT NULL,"averageGrade" DOUBLE PRECISION NOT NULL) WITH OIDS;
ALTER SEQUENCE wine_guess."club_wine_stat_clubWineStatId_seq" RESTART WITH 14 INCREMENT BY 1;
DROP INDEX IF EXISTS "PRIMARY00001";
ALTER TABLE wine_guess."club_wine_stat" ADD CONSTRAINT "PRIMARY00001" PRIMARY KEY ("clubWineStatId");

/*
Dumping data for table 'public.club_wine_stat'
*/

INSERT INTO wine_guess."club_wine_stat"("clubWineStatId", "clubId", "wineName", "wineUrl", "numberOfServings", "averageGrade")VALUES (1, 1, 'Penfolds Koonunga Hill', 'https://www.systembolaget.se/dryck/roda-viner/penfolds-koonunga-hill-625302', 1, 2.7999999999999998e+00);
INSERT INTO wine_guess."club_wine_stat"("clubWineStatId", "clubId", "wineName", "wineUrl", "numberOfServings", "averageGrade")VALUES (2, 1, 'Marques De Arienzo', 'https://www.systembolaget.se/dryck/roda-viner/marques-de-arienzo-271002', 1, 3.7999999999999998e+00);
INSERT INTO wine_guess."club_wine_stat"("clubWineStatId", "clubId", "wineName", "wineUrl", "numberOfServings", "averageGrade")VALUES (3, 2, 'Villa Righetti', 'https://www.systembolaget.se/dryck/roda-viner/villa-righetti-7630801', 2, 3.1499999999999999e+00);
INSERT INTO wine_guess."club_wine_stat"("clubWineStatId", "clubId", "wineName", "wineUrl", "numberOfServings", "averageGrade")VALUES (4, 2, 'Ecoltura', 'https://www.systembolaget.se/dryck/roda-viner/ecoltura-7912501', 12, 2.9600000000000000e+00);
INSERT INTO wine_guess."club_wine_stat"("clubWineStatId", "clubId", "wineName", "wineUrl", "numberOfServings", "averageGrade")VALUES (5, 2, 'First Edition', 'https://www.systembolaget.se/dryck/roda-viner/first-edition-227801', 7, 3.2999999999999998e+00);
INSERT INTO wine_guess."club_wine_stat"("clubWineStatId", "clubId", "wineName", "wineUrl", "numberOfServings", "averageGrade")VALUES (6, 2, 'La Rioja Alta', 'https://www.systembolaget.se/dryck/roda-viner/la-rioja-alta-746201', 11, 3.4800000000000000e+00);
INSERT INTO wine_guess."club_wine_stat"("clubWineStatId", "clubId", "wineName", "wineUrl", "numberOfServings", "averageGrade")VALUES (7, 2, 'Apothic Red', 'https://www.systembolaget.se/dryck/roda-viner/apothic-red-642008', 7, 3.5000000000000000e+00);
INSERT INTO wine_guess."club_wine_stat"("clubWineStatId", "clubId", "wineName", "wineUrl", "numberOfServings", "averageGrade")VALUES (8, 2, 'Barbera Del Monferrato', 'https://www.systembolaget.se/dryck/roda-viner/barbera-del-monferrato-7496001', 1, 5.0000000000000000e+00);
INSERT INTO wine_guess."club_wine_stat"("clubWineStatId", "clubId", "wineName", "wineUrl", "numberOfServings", "averageGrade")VALUES (9, 3, 'Diemersfontein', 'https://www.systembolaget.se/dryck/roda-viner/diemersfontein-631501', 1, 3.2000000000000002e+00);
INSERT INTO wine_guess."club_wine_stat"("clubWineStatId", "clubId", "wineName", "wineUrl", "numberOfServings", "averageGrade")VALUES (10, 3, 'Montelciego', 'https://www.systembolaget.se/dryck/roda-viner/montelciego-7843501', 1, 3.0000000000000000e+00);
INSERT INTO wine_guess."club_wine_stat"("clubWineStatId", "clubId", "wineName", "wineUrl", "numberOfServings", "averageGrade")VALUES (11, 3, 'Governo', 'https://www.systembolaget.se/dryck/roda-viner/governo-7252601', 1, 3.5000000000000000e+00);
INSERT INTO wine_guess."club_wine_stat"("clubWineStatId", "clubId", "wineName", "wineUrl", "numberOfServings", "averageGrade")VALUES (12, 3, 'Baron De Ley', 'https://www.systembolaget.se/dryck/roda-viner/baron-de-ley-276801', 1, 3.2999999999999998e+00);
INSERT INTO wine_guess."club_wine_stat"("clubWineStatId", "clubId", "wineName", "wineUrl", "numberOfServings", "averageGrade")VALUES (13, 2, 'Mcmanis', 'https://www.systembolaget.se/dryck/roda-viner/mcmanis-9946001', 1, 3.5000000000000000e+00);

/*
Table structure for table 'public.game_point'
*/

DROP TABLE IF EXISTS wine_guess."game_point" CASCADE;
CREATE TABLE wine_guess."game_point"("gamePointId" SERIAL NOT NULL,"gameResultId" INTEGER NOT NULL,"username" VARCHAR(255) NOT NULL,"points" INTEGER NOT NULL,"pointsNoRegion" INTEGER NOT NULL) WITH OIDS;
ALTER SEQUENCE wine_guess."game_point_gamePointId_seq" RESTART WITH 85 INCREMENT BY 1;
DROP INDEX IF EXISTS "PRIMARY00002";
ALTER TABLE wine_guess."game_point" ADD CONSTRAINT "PRIMARY00002" PRIMARY KEY ("gamePointId");

/*
Dumping data for table 'public.game_point'
*/

INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (1, 1, 'Carina', 3, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (2, 1, 'Felix', 3, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (3, 1, 'Linnea', 1, 0);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (4, 1, 'Vinberra', 3, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (5, 2, 'As', 2, 1);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (6, 2, 'cartop1', 2, 1);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (7, 2, 'cartop2', 2, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (8, 2, 'LINTOP', 5, 4);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (9, 2, 'lintop2', 1, 1);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (10, 2, 'TestFelix1', 0, 0);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (11, 2, 'TestFelix2', 0, 0);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (12, 2, 'TestFelix3', 1, 0);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (13, 2, 'Vinproffset', 3, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (14, 3, 'TestFelix1', 2, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (15, 3, 'TestFelix2', 1, 0);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (16, 4, 'TestFelix1', 2, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (17, 5, 'TestFelix1', 3, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (18, 5, 'TestFelix2', 2, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (19, 7, 'TestFelix1', 4, 4);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (20, 7, 'TestFelix2', 0, 0);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (21, 8, 'TestFelix1', 1, 0);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (22, 8, 'TestFelix2', 1, 0);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (23, 9, 'TestFelix1', 2, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (24, 9, 'TestFelix2', 2, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (25, 10, 'TestFelix1', 1, 0);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (26, 11, 'TestFelix1', 3, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (27, 11, 'TestFelix2', 1, 1);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (28, 12, 'Carina', 1, 0);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (29, 12, 'dagny', 4, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (30, 12, 'Felix', 3, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (31, 12, 'Ingalill', 3, 1);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (32, 12, 'JUKKA', 1, 0);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (33, 12, 'Lillamy', 3, 1);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (34, 12, 'Linnea', 1, 0);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (35, 12, 'LÃ¥dvinsViktor', 1, 0);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (36, 12, 'steffe rfe', 1, 0);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (37, 12, 'Tove', 3, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (38, 12, 'Vinberra', 2, 1);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (39, 13, 'TestFelix1', 0, 0);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (40, 14, 'TestFelix1', 1, 0);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (41, 14, 'TestFelix2', 2, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (42, 15, 'TestFelix1', 1, 1);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (43, 16, 'TestFelix1', 3, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (44, 17, 'TestFelix1', 3, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (45, 16, 'TestFelix2', 3, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (46, 17, 'TestFelix2', 3, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (47, 18, 'TestFelix1', 2, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (48, 19, 'TestFelix1', 2, 2);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (49, 18, 'TestFelix2', 0, 0);
INSERT INTO wine_guess."game_point"("gamePointId", "gameResultId", "username", "points", "pointsNoRegion")VALUES (50, 20, 'TestFelix3', 0, 0);

/*
Table structure for table 'public.game_result'
*/

DROP TABLE IF EXISTS wine_guess."game_result" CASCADE;
CREATE TABLE wine_guess."game_result"("gameResultId" SERIAL NOT NULL,"gameId" VARCHAR(255) NOT NULL,"url" VARCHAR(8000) NOT NULL,"comment" VARCHAR(8000)) WITH OIDS;
ALTER SEQUENCE wine_guess."game_result_gameResultId_seq" RESTART WITH 55 INCREMENT BY 1;
DROP INDEX IF EXISTS "PRIMARY00003";
ALTER TABLE wine_guess."game_result" ADD CONSTRAINT "PRIMARY00003" PRIMARY KEY ("gameResultId");

/*
Dumping data for table 'public.game_result'
*/

INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (1, '502437', 'wineguesser.herokuapp.com/gameResults/502437', 'Valborg.
Mat: Grillad kycklingfile med mangosalsa och vitlÃ¶ksbrÃ¶d, tapas snacks och gurka.

NÃ¤rvarande: Hela KlubbToppar.

Plats: Hemma.');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (2, '365249', 'wineguesser.herokuapp.com/gameResults/365249', 'How did I escape Iraq?

Iran.');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (3, '939654', 'wineguesser.herokuapp.com/gameResults/939654', 'qaasdads');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (4, '481712', 'wineguesser.herokuapp.com/gameResults/481712', 'sadasd');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (5, '378335', 'wineguesser.herokuapp.com/gameResults/378335', 'gggd');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (7, '598039', 'wineguesser.herokuapp.com/gameResults/598039', 'asdasdda');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (8, '940586', 'wineguesser.herokuapp.com/gameResults/940586', 'asadad');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (9, '769978', 'wineguesser.herokuapp.com/gameResults/769978', 'asdasda');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (10, '466144', 'wineguesser.herokuapp.com/gameResults/466144', 'asda');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (11, '178198', 'wineguesser.herokuapp.com/gameResults/178198', 'asdasd');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (12, '200434', 'wineguesser.herokuapp.com/gameResults/200434', 'FÃ¶rsta digitala provningen.
...
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (13, '487431', 'wineguesser.herokuapp.com/gameResults/487431', 'fÃ¶rsta test efter paus i utveckling');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (14, '292396', 'wineguesser.herokuapp.com/gameResults/292396', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (15, '236610', 'wineguesser.herokuapp.com/gameResults/236610', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (16, '737931', 'wineguesser.herokuapp.com/gameResults/737931', 'Testar deadlock');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (18, '522373', 'wineguesser.herokuapp.com/gameResults/522373', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (20, '855185', 'wineguesser.herokuapp.com/gameResults/855185', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (22, '867264', 'wineguesser.herokuapp.com/gameResults/867264', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (23, '867264', 'wineguesser.herokuapp.com/gameResults/867264', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (24, '643737', 'wineguesser.herokuapp.com/gameResults/643737', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (25, '155360', 'wineguesser.herokuapp.com/gameResults/155360', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (28, '247136', 'wineguesser.herokuapp.com/gameResults/247136', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (29, '167419', 'wineguesser.herokuapp.com/gameResults/167419', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (31, '668422', 'wineguesser.herokuapp.com/gameResults/668422', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (33, '302215', 'wineguesser.herokuapp.com/gameResults/302215', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (34, '302215', 'wineguesser.herokuapp.com/gameResults/302215', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (35, '187704', 'wineguesser.herokuapp.com/gameResults/187704', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (36, '187704', 'wineguesser.herokuapp.com/gameResults/187704', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (37, '570049', 'wineguesser.herokuapp.com/gameResults/570049', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (38, '570049', 'wineguesser.herokuapp.com/gameResults/570049', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (39, '554472', 'wineguesser.herokuapp.com/gameResults/554472', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (40, '554472', 'wineguesser.herokuapp.com/gameResults/554472', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (41, '779502', 'wineguesser.herokuapp.com/gameResults/779502', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (42, '779502', 'wineguesser.herokuapp.com/gameResults/779502', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (43, '129842', 'wineguesser.herokuapp.com/gameResults/129842', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (44, '133971', 'wineguesser.herokuapp.com/gameResults/133971', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (45, '133971', 'wineguesser.herokuapp.com/gameResults/133971', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (46, '937745', 'wineguesser.herokuapp.com/gameResults/937745', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (47, '937745', 'wineguesser.herokuapp.com/gameResults/937745', '');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (48, '272681', 'wineguesser.herokuapp.com/gameResults/272681', 'asdasd');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (50, '581985', 'wineguesser.herokuapp.com/gameResults/581985', 'test');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (51, '677023', 'wineguesser.herokuapp.com/gameResults/677023', '214124');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (53, '690081', 'wineguesser.herokuapp.com/gameResults/690081', 'test 2 player');
INSERT INTO wine_guess."game_result"("gameResultId", "gameId", "url", "comment")VALUES (54, '234922', 'wineguesser.herokuapp.com/gameResults/234922', 'Potatis och ris');

/*
Table structure for table 'public.game_settings'
*/

DROP TABLE IF EXISTS wine_guess."game_settings" CASCADE;
CREATE TABLE wine_guess."game_settings"("gameSettingsId" BIGSERIAL NOT NULL,"gameHost" VARCHAR(255) NOT NULL,"gameId" VARCHAR(255) NOT NULL,"qrCode" VARCHAR(8000) NOT NULL,"url" VARCHAR(8000) NOT NULL,"imgSource" VARCHAR(8000) NOT NULL,"wineName" VARCHAR(255) NOT NULL,"region" VARCHAR(8000) ,"description" VARCHAR(8000) NOT NULL,"servingOrder" VARCHAR(255)) WITH OIDS;
ALTER SEQUENCE wine_guess."game_settings_gameSettingsId_seq" RESTART WITH 138 INCREMENT BY 1;
DROP INDEX IF EXISTS "PRIMARY00004";
ALTER TABLE wine_guess."game_settings" ADD CONSTRAINT "PRIMARY00004" PRIMARY KEY ("gameSettingsId");

/*
Dumping data for table 'public.game_settings'
*/

INSERT INTO wine_guess."game_settings"("gameSettingsId", "gameHost", "gameId", "qrCode", "url", "imgSource", "wineName", "region", "description", "servingOrder")VALUES (52, 'Felix', '200434', '', 'https://www.systembolaget.se/dryck/roda-viner/governo-7252601', 'https://static.systembolaget.se/imagelibrary/publishedmedia/e2becfq78oey4ch81vul/819205.jpg', 'Governo', '', 'Smak: Fruktig smak med fatkaraktÃ¤r, inslag av mÃ¶rka kÃ¶rsbÃ¤r, russin, choklad, sÃ¶tlakrits och vanilj.
...
DROP TABLE IF EXISTS wine_guess."game_setup" CASCADE;
CREATE TABLE wine_guess."game_setup"("gameHost" VARCHAR(255) NOT NULL,"amountOfWines" VARCHAR(255) NOT NULL,"gameId" VARCHAR(255) NOT NULL,"clubName" VARCHAR(255) ,"comment" VARCHAR(8000)) WITH OIDS;
DROP INDEX IF EXISTS "PRIMARY00005";
ALTER TABLE wine_guess."game_setup" ADD CONSTRAINT "PRIMARY00005" PRIMARY KEY ("gameId");

/*
Dumping data for table 'public.game_setup'
*/

INSERT INTO wine_guess."game_setup"("gameHost", "amountOfWines", "gameId", "clubName", "comment")VALUES ('Felix', '2', '367782', '', '');
INSERT INTO wine_guess."game_setup"("gameHost", "amountOfWines", "gameId", "clubName", "comment")VALUES ('hej', '2', '655309', '', 'hej');

/*
Table structure for table 'public.judgement'
*/

DROP TABLE IF EXISTS wine_guess."judgement" CASCADE;
CREATE TABLE wine_guess."judgement"("judgementId" SERIAL NOT NULL,"username" VARCHAR(255) NOT NULL,"servingOrder" INTEGER NOT NULL,"personalGrade" INTEGER NOT NULL,"gameId" VARCHAR(255) NOT NULL) WITH OIDS;
ALTER SEQUENCE wine_guess."judgement_judgementId_seq" RESTART WITH 61 INCREMENT BY 1;
DROP INDEX IF EXISTS "PRIMARY00006";
ALTER TABLE wine_guess."judgement" ADD CONSTRAINT "PRIMARY00006" PRIMARY KEY ("judgementId");

/*
Dumping data for table 'public.judgement'
*/

INSERT INTO wine_guess."judgement"("judgementId", "username", "servingOrder", "personalGrade", "gameId")VALUES (41, 'TestFelix3', 1, 2, '167419');
INSERT INTO wine_guess."judgement"("judgementId", "username", "servingOrder", "personalGrade", "gameId")VALUES (42, 'TestFelix3', 2, 4, '167419');
INSERT INTO wine_guess."judgement"("judgementId", "username", "servingOrder", "personalGrade", "gameId")VALUES (43, 'TestFelix3', 1, 5, '668422');
INSERT INTO wine_guess."judgement"("judgementId", "username", "servingOrder", "personalGrade", "gameId")VALUES (44, 'TestFelix3', 2, 1, '668422');
INSERT INTO wine_guess."judgement"("judgementId", "username", "servingOrder", "personalGrade", "gameId")VALUES (45, 'TestFelix3', 1, 4, '302215');
INSERT INTO wine_guess."judgement"("judgementId", "username", "servingOrder", "personalGrade", "gameId")VALUES (46, 'TestFelix3', 2, 3, '302215');
INSERT INTO wine_guess."judgement"("judgementId", "username", "servingOrder", "personalGrade", "gameId")VALUES (47, 'TestFelix3', 1, 2, '187704');
INSERT INTO wine_guess."judgement"("judgementId", "username", "servingOrder", "personalGrade", "gameId")VALUES (48, 'TestFelix3', 2, 4, '187704');
INSERT INTO wine_guess."judgement"("judgementId", "username", "servingOrder", "personalGrade", "gameId")VALUES (49, 'TestFelix3', 1, 2, '570049');
INSERT INTO wine_guess."judgement"("judgementId", "username", "servingOrder", "personalGrade", "gameId")VALUES (50, 'TestFelix3', 2, 4, '570049');
INSERT INTO wine_guess."judgement"("judgementId", "username", "servingOrder", "personalGrade", "gameId")VALUES (51, 'TestFelix3', 1, 2, '554472');
INSERT INTO wine_guess."judgement"("judgementId", "username", "servingOrder", "personalGrade", "gameId")VALUES (52, 'TestFelix3', 2, 4, '554472');
INSERT INTO wine_guess."judgement"("judgementId", "username", "servingOrder", "personalGrade", "gameId")VALUES (53, 'TestFelix3', 1, 2, '779502');
INSERT INTO wine_guess."judgement"("judgementId", "username", "servingOrder", "personalGrade", "gameId")VALUES (54, 'TestFelix3', 2, 4, '779502');
INSERT INTO wine_guess."judgement"("judgementId", "username", "servingOrder", "personalGrade", "gameId")VALUES (57, 'TestFelix2', 1, 4, '133971');
INSERT INTO wine_guess."judgement"("judgementId", "username", "servingOrder", "personalGrade", "gameId")VALUES (58, 'TestFelix2', 2, 3, '133971');
INSERT INTO wine_guess."judgement"("judgementId", "username", "servingOrder", "personalGrade", "gameId")VALUES (59, 'TestFelix1', 1, 2, '937745');
INSERT INTO wine_guess."judgement"("judgementId", "username", "servingOrder", "personalGrade", "gameId")VALUES (60, 'TestFelix1', 2, 4, '937745');

/*
Table structure for table 'public.lobby'
*/

DROP TABLE IF EXISTS wine_guess."lobby" CASCADE;
CREATE TABLE wine_guess."lobby"("lobbyId" BIGSERIAL NOT NULL,"gameId" VARCHAR(255) NOT NULL,"gameStart" VARCHAR(255) NOT NULL) WITH OIDS;
ALTER SEQUENCE wine_guess."lobby_lobbyId_seq" RESTART WITH 51 INCREMENT BY 1;
DROP INDEX IF EXISTS "PRIMARY00007";
ALTER TABLE wine_guess."lobby" ADD CONSTRAINT "PRIMARY00007" PRIMARY KEY ("lobbyId");

/*
Dumping data for table 'public.lobby'
*/

INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (1, '502437', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (2, '365249', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (3, '140282', 'canceled');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (4, '939654', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (5, '481712', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (6, '378335', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (7, '238238', 'canceled');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (8, '454591', 'canceled');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (9, '225752', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (10, '618728', 'canceled');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (11, '598039', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (12, '180233', 'canceled');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (13, '940586', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (14, '769978', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (15, '466144', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (16, '178198', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (17, '200434', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (18, '655309', 'started');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (19, '487431', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (20, '292396', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (21, '236610', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (22, '737931', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (23, '522373', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (24, '855185', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (25, '867264', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (26, '643737', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (27, '155360', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (28, '558125', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (29, '289275', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (30, '203847', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (31, '247136', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (32, '167419', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (33, '668422', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (34, '302215', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (35, '187704', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (36, '570049', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (37, '554472', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (38, '937745', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (39, '779502', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (40, '129842', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (41, '133971', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (42, '272681', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (43, '581985', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (44, '677023', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (45, '690081', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (46, '486663', 'canceled');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (47, '293388', 'canceled');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (48, '741277', 'canceled');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (49, '234922', 'finished');
INSERT INTO wine_guess."lobby"("lobbyId", "gameId", "gameStart")VALUES (50, '220207', 'canceled');

/*
Table structure for table 'public.lobby_data'
*/

DROP TABLE IF EXISTS wine_guess."lobby_data" CASCADE;
CREATE TABLE wine_guess."lobby_data"("lobbyId" BIGINT NOT NULL,"gameHost" VARCHAR(255) ,"gameId" VARCHAR(255) NOT NULL,"participants" VARCHAR(255) NOT NULL,"score" INTEGER DEFAULT 0,"ready" INTEGER DEFAULT 0,"done" INTEGER DEFAULT 0) WITH OIDS;
DROP INDEX IF EXISTS "PRIMARY00008";
ALTER TABLE wine_guess."lobby_data" ADD CONSTRAINT "PRIMARY00008" PRIMARY KEY ("participants");
...
DROP TABLE IF EXISTS wine_guess."lobby_history" CASCADE;
CREATE TABLE wine_guess."lobby_history"("lobbyId" BIGINT NOT NULL,"gameHost" VARCHAR(255) ,"gameId" VARCHAR(255) NOT NULL,"participants" VARCHAR(255) NOT NULL,"score" INTEGER DEFAULT 0,"ready" INTEGER DEFAULT 0,"done" INTEGER DEFAULT 0) WITH OIDS;
DROP INDEX IF EXISTS "PRIMARY00009";
ALTER TABLE wine_guess."lobby_history" ADD CONSTRAINT "PRIMARY00009" PRIMARY KEY ("participants");

/*
Dumping data for table 'public.lobby_history'
*/

INSERT INTO wine_guess."lobby_history"("lobbyId", "gameHost", "gameId", "participants", "score", "ready", "done")VALUES (3, '', '140282', 'cartop1', 0, 1, 0);
INSERT INTO wine_guess."lobby_history"("lobbyId", "gameHost", "gameId", "participants", "score", "ready", "done")VALUES (12, 'Felix', '180233', 'Felix', 0, 0, 0);
INSERT INTO wine_guess."lobby_history"("lobbyId", "gameHost", "gameId", "participants", "score", "ready", "done")VALUES (18, 'hej', '655309', 'hej', 0, 0, 0);
INSERT INTO wine_guess."lobby_history"("lobbyId", "gameHost", "gameId", "participants", "score", "ready", "done")VALUES (50, 'TestFelix1', '220207', 'TestFelix1', 0, 0, 0);
INSERT INTO wine_guess."lobby_history"("lobbyId", "gameHost", "gameId", "participants", "score", "ready", "done")VALUES (45, '', '690081', 'TestFelix2', 0, 0, 0);

/*
Table structure for table 'public.match_history'
*/

DROP TABLE IF EXISTS wine_guess."match_history" CASCADE;
CREATE TABLE wine_guess."match_history"("matchHistoryId" SERIAL NOT NULL,"userResultsId" INTEGER NOT NULL,"datePlayed" VARCHAR(255) NOT NULL,"url" VARCHAR(255) NOT NULL,"gameId" VARCHAR(255) NOT NULL,"clubName" VARCHAR(255)) WITH OIDS;
ALTER SEQUENCE wine_guess."match_history_matchHistoryId_seq" RESTART WITH 88 INCREMENT BY 1;
DROP INDEX IF EXISTS "PRIMARY00010";
ALTER TABLE wine_guess."match_history" ADD CONSTRAINT "PRIMARY00010" PRIMARY KEY ("matchHistoryId");

/*
Dumping data for table 'public.match_history'
*/

INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (1, 2, '2019-04-30', 'wineguesser.herokuapp.com/gameResults/502437', '502437', 'KlubbToppar');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (2, 1, '2019-04-30', 'wineguesser.herokuapp.com/gameResults/502437', '502437', 'KlubbToppar');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (3, 3, '2019-04-30', 'wineguesser.herokuapp.com/gameResults/502437', '502437', 'KlubbToppar');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (4, 4, '2019-04-30', 'wineguesser.herokuapp.com/gameResults/502437', '502437', 'KlubbToppar');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (5, 8, '2019-05-01', 'wineguesser.herokuapp.com/gameResults/365249', '365249', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (6, 10, '2019-05-01', 'wineguesser.herokuapp.com/gameResults/365249', '365249', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (7, 11, '2019-05-01', 'wineguesser.herokuapp.com/gameResults/365249', '365249', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (8, 12, '2019-05-01', 'wineguesser.herokuapp.com/gameResults/365249', '365249', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (9, 13, '2019-05-01', 'wineguesser.herokuapp.com/gameResults/365249', '365249', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (10, 5, '2019-05-01', 'wineguesser.herokuapp.com/gameResults/365249', '365249', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (11, 6, '2019-05-01', 'wineguesser.herokuapp.com/gameResults/365249', '365249', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (12, 7, '2019-05-01', 'wineguesser.herokuapp.com/gameResults/365249', '365249', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (13, 9, '2019-05-01', 'wineguesser.herokuapp.com/gameResults/365249', '365249', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (14, 5, '2019-05-01', 'wineguesser.herokuapp.com/gameResults/939654', '939654', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (15, 6, '2019-05-01', 'wineguesser.herokuapp.com/gameResults/939654', '939654', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (16, 5, '2019-05-01', 'wineguesser.herokuapp.com/gameResults/481712', '481712', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (17, 5, '2019-05-02', 'wineguesser.herokuapp.com/gameResults/378335', '378335', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (18, 6, '2019-05-02', 'wineguesser.herokuapp.com/gameResults/378335', '378335', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (19, 5, '2019-05-03', 'wineguesser.herokuapp.com/gameResults/225752', '225752', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (20, 5, '2019-05-03', 'wineguesser.herokuapp.com/gameResults/598039', '598039', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (21, 6, '2019-05-03', 'wineguesser.herokuapp.com/gameResults/598039', '598039', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (22, 5, '2019-05-03', 'wineguesser.herokuapp.com/gameResults/940586', '940586', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (23, 6, '2019-05-03', 'wineguesser.herokuapp.com/gameResults/940586', '940586', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (24, 5, '2019-05-03', 'wineguesser.herokuapp.com/gameResults/769978', '769978', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (25, 6, '2019-05-03', 'wineguesser.herokuapp.com/gameResults/769978', '769978', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (26, 5, '2019-05-03', 'wineguesser.herokuapp.com/gameResults/466144', '466144', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (27, 5, '2019-05-03', 'wineguesser.herokuapp.com/gameResults/178198', '178198', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (28, 6, '2019-05-03', 'wineguesser.herokuapp.com/gameResults/178198', '178198', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (29, 2, '2019-05-04', 'wineguesser.herokuapp.com/gameResults/200434', '200434', 'RiojaKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (30, 21, '2019-05-04', 'wineguesser.herokuapp.com/gameResults/200434', '200434', 'RiojaKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (31, 1, '2019-05-04', 'wineguesser.herokuapp.com/gameResults/200434', '200434', 'RiojaKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (32, 19, '2019-05-04', 'wineguesser.herokuapp.com/gameResults/200434', '200434', 'RiojaKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (33, 22, '2019-05-04', 'wineguesser.herokuapp.com/gameResults/200434', '200434', 'RiojaKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (34, 18, '2019-05-04', 'wineguesser.herokuapp.com/gameResults/200434', '200434', 'RiojaKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (35, 3, '2019-05-04', 'wineguesser.herokuapp.com/gameResults/200434', '200434', 'RiojaKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (36, 16, '2019-05-04', 'wineguesser.herokuapp.com/gameResults/200434', '200434', 'RiojaKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (37, 20, '2019-05-04', 'wineguesser.herokuapp.com/gameResults/200434', '200434', 'RiojaKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (38, 17, '2019-05-04', 'wineguesser.herokuapp.com/gameResults/200434', '200434', 'RiojaKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (39, 4, '2019-05-04', 'wineguesser.herokuapp.com/gameResults/200434', '200434', 'RiojaKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (40, 5, '2019-09-13', 'wineguesser.herokuapp.com/gameResults/487431', '487431', '');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (41, 5, '2019-09-13', 'wineguesser.herokuapp.com/gameResults/292396', '292396', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (42, 6, '2019-09-13', 'wineguesser.herokuapp.com/gameResults/292396', '292396', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (43, 5, '2019-09-13', 'wineguesser.herokuapp.com/gameResults/236610', '236610', '');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (44, 5, '2019-09-13', 'wineguesser.herokuapp.com/gameResults/737931', '737931', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (45, 5, '2019-09-13', 'wineguesser.herokuapp.com/gameResults/737931', '737931', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (46, 6, '2019-09-13', 'wineguesser.herokuapp.com/gameResults/737931', '737931', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (47, 6, '2019-09-13', 'wineguesser.herokuapp.com/gameResults/737931', '737931', 'TestKlubben');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (48, 5, '2019-09-13', 'wineguesser.herokuapp.com/gameResults/522373', '522373', '');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (49, 5, '2019-09-13', 'wineguesser.herokuapp.com/gameResults/522373', '522373', '');
INSERT INTO wine_guess."match_history"("matchHistoryId", "userResultsId", "datePlayed", "url", "gameId", "clubName")VALUES (50, 6, '2019-09-13', 'wineguesser.herokuapp.com/gameResults/522373', '522373', '');

/*
Table structure for table 'public.result_data'
*/

DROP TABLE IF EXISTS wine_guess."result_data" CASCADE;
CREATE TABLE wine_guess."result_data"("resultDataId" SERIAL NOT NULL,"gameResultId" INTEGER NOT NULL,"username" VARCHAR(255) NOT NULL,"servingOrder" INTEGER NOT NULL,"winePicture" VARCHAR(8000) NOT NULL,"wineName" VARCHAR(255) NOT NULL,"wineDescription" VARCHAR(8000) NOT NULL,"grade" INTEGER NOT NULL,"url" VARCHAR(8000) NOT NULL,"personalGrade" INTEGER NOT NULL,"averageGrade" DOUBLE PRECISION NOT NULL,"region" VARCHAR(255) ,"correctRegionGuess" VARCHAR(255)) WITH OIDS;
ALTER SEQUENCE wine_guess."result_data_resultDataId_seq" RESTART WITH 245 INCREMENT BY 1;
DROP INDEX IF EXISTS "PRIMARY00011";
ALTER TABLE wine_guess."result_data" ADD CONSTRAINT "PRIMARY00011" PRIMARY KEY ("resultDataId");

/*
Dumping data for table 'public.result_data'
*/

INSERT INTO wine_guess."result_data"("resultDataId", "gameResultId", "username", "servingOrder", "winePicture", "wineName", "wineDescription", "grade", "url", "personalGrade", "averageGrade", "region", "correctRegionGuess")VALUES (1, 1, 'Carina', 1, 'https://static.systembolaget.se/imagelibrary/publishedmedia/hhzjq2ymt4r5us2un7y9/256950.jpg', 'Penfolds Koonunga Hill', 'Smak: Mycket fruktig smak med fatkaraktÃ¤r, inslag av svarta vinbÃ¤r, plommon, kaffe, mynta, vanilj och mÃ¶rk choklad.
...
DROP TABLE IF EXISTS wine_guess."user" CASCADE;
CREATE TABLE wine_guess."user"("userId" BIGSERIAL NOT NULL,"username" VARCHAR(255) NOT NULL,"password" VARCHAR(255) NOT NULL,"activeGame" VARCHAR(255)) WITH OIDS;
ALTER SEQUENCE wine_guess."user_userId_seq" RESTART WITH 23 INCREMENT BY 1;
DROP INDEX IF EXISTS "PRIMARY00012";
ALTER TABLE wine_guess."user" ADD CONSTRAINT "PRIMARY00012"  PRIMARY KEY ("userId");
...
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (1, 'Felix', 'hejmorma80', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (2, 'Carina', 'qwe', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (3, 'Linnea', 'katt', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (4, 'Vinberra', 'vatrodu', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (5, 'TestFelix1', '123', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (6, 'TestFelix2', '123', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (7, 'TestFelix3', '123', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (8, 'As', 'df', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (9, 'Vinproffset', '123', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (10, 'cartop1', '123', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (11, 'cartop2', '234', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (12, 'LINTOP', 'kanin', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (13, 'lintop2', 'hÃ¤st', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (14, 'hej', '123', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (16, 'LÃ¥dvinsViktor', 'Vin', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (17, 'Tove', '19980109', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (18, 'Lillamy', '7Bubbelgum', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (19, 'Ingalill', 'lillan1448', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (20, 'steffe rfe', 'rioja', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (21, 'dagny', '123', '');
INSERT INTO wine_guess."user"("userId", "username", "password", "activeGame")VALUES (22, 'JUKKA', 'vino', '');

/*
Table structure for table 'public.user_guesses'
*/

DROP TABLE IF EXISTS wine_guess."user_guesses" CASCADE;
CREATE TABLE wine_guess."user_guesses"("userGuessesId" BIGSERIAL NOT NULL,"username" VARCHAR(255) NOT NULL,"servingOrderGuess" INTEGER NOT NULL,"descriptionGuess" VARCHAR(8000) NOT NULL,"gameId" VARCHAR(255) NOT NULL,"regionGuess" VARCHAR(255)) WITH OIDS;
ALTER SEQUENCE wine_guess."user_guesses_userGuessesId_seq" RESTART WITH 1 INCREMENT BY 1;
DROP INDEX IF EXISTS "PRIMARY00013";
ALTER TABLE wine_guess."user_guesses" ADD CONSTRAINT "PRIMARY00013" PRIMARY KEY ("userGuessesId");
...
DROP TABLE IF EXISTS wine_guess."user_results" CASCADE;
CREATE TABLE wine_guess."user_results"("userResultsId" SERIAL NOT NULL,"username" VARCHAR(255) NOT NULL,"playedGames" INTEGER DEFAULT 0,"numWinesGuessed" DOUBLE PRECISION DEFAULT 0.0000000000000000e+00,"numWinesCorrect" DOUBLE PRECISION DEFAULT 0.0000000000000000e+00,"correctPercent" DOUBLE PRECISION DEFAULT 0.0000000000000000e+00,"wins" INTEGER DEFAULT 0,"isBacchus" VARCHAR(255) NOT NULL) WITH OIDS;
ALTER SEQUENCE wine_guess."user_results_userResultsId_seq" RESTART WITH 23 INCREMENT BY 1;
DROP INDEX IF EXISTS "PRIMARY00014";
ALTER TABLE wine_guess."user_results" ADD CONSTRAINT "PRIMARY00014" PRIMARY KEY ("userResultsId");

/*
Dumping data for table 'public.user_results'
*/

INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (1, 'Felix', 2, 6.0000000000000000e+00, 4.0000000000000000e+00, 6.7000000000000004e-01, 1, 'false');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (2, 'Carina', 2, 6.0000000000000000e+00, 2.0000000000000000e+00, 3.3000000000000002e-01, 1, 'false');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (3, 'Linnea', 2, 6.0000000000000000e+00, 0.0000000000000000e+00, 0.0000000000000000e+00, 0, 'false');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (4, 'Vinberra', 2, 6.0000000000000000e+00, 3.0000000000000000e+00, 5.0000000000000000e-01, 1, 'false');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (5, 'TestFelix1', 22, 6.5000000000000000e+01, 2.9000000000000000e+01, 4.5000000000000001e-01, 19, 'false');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (6, 'TestFelix2', 14, 4.4000000000000000e+01, 1.5000000000000000e+01, 3.4000000000000002e-01, 7, 'true');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (7, 'TestFelix3', 16, 3.4000000000000000e+01, 2.0000000000000000e+01, 5.8999999999999997e-01, 15, 'true');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (8, 'As', 1, 4.0000000000000000e+00, 1.0000000000000000e+00, 2.5000000000000000e-01, 0, 'false');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (9, 'Vinproffset', 1, 4.0000000000000000e+00, 2.0000000000000000e+00, 5.0000000000000000e-01, 0, 'false');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (10, 'cartop1', 1, 4.0000000000000000e+00, 1.0000000000000000e+00, 2.5000000000000000e-01, 0, 'false');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (11, 'cartop2', 1, 4.0000000000000000e+00, 2.0000000000000000e+00, 5.0000000000000000e-01, 0, 'false');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (12, 'LINTOP', 1, 4.0000000000000000e+00, 4.0000000000000000e+00, 1.0000000000000000e+00, 1, 'true');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (13, 'lintop2', 1, 4.0000000000000000e+00, 1.0000000000000000e+00, 2.5000000000000000e-01, 0, 'false');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (14, 'hej', 0, 0.0000000000000000e+00, 0.0000000000000000e+00, 0.0000000000000000e+00, 0, 'false');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (15, 'Sara', 0, 0.0000000000000000e+00, 0.0000000000000000e+00, 0.0000000000000000e+00, 0, 'false');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (16, 'LÃ¥dvinsViktor', 1, 4.0000000000000000e+00, 0.0000000000000000e+00, 0.0000000000000000e+00, 0, 'false');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (17, 'Tove', 1, 4.0000000000000000e+00, 2.0000000000000000e+00, 5.0000000000000000e-01, 0, 'false');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (18, 'Lillamy', 1, 4.0000000000000000e+00, 1.0000000000000000e+00, 2.5000000000000000e-01, 0, 'false');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (19, 'Ingalill', 1, 4.0000000000000000e+00, 1.0000000000000000e+00, 2.5000000000000000e-01, 0, 'false');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (20, 'steffe rfe', 1, 4.0000000000000000e+00, 0.0000000000000000e+00, 0.0000000000000000e+00, 0, 'false');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (21, 'dagny', 1, 4.0000000000000000e+00, 2.0000000000000000e+00, 5.0000000000000000e-01, 1, 'true');
INSERT INTO wine_guess."user_results"("userResultsId", "username", "playedGames", "numWinesGuessed", "numWinesCorrect", "correctPercent", "wins", "isBacchus")VALUES (22, 'JUKKA', 1, 4.0000000000000000e+00, 0.0000000000000000e+00, 0.0000000000000000e+00, 0, 'false');
